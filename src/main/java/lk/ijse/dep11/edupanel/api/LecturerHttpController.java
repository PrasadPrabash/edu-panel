...
public class LecturerHttpController {
    ...
    public void updateLectureDetailsViaJson(@PathVariable("lecturer-id")  Integer  lecturerId){}

    @ResponseStatus(HttpStatus.NO_CONTENT)
    @DeleteMapping("/{lecturer-id}")
    public void deleteLecture(@PathVariable("lecturer-id")  Integer  lecturerId){}

    @GetMapping(produces = "application/json")
    public void getAllLecturers(){}

    @DeleteMapping(value = "/{lecturer-id}", produces = "application/json")
